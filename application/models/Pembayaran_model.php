...
class pembayaran_model extends CI_Model
{
    ...
    public function getBookingById($id)
    {
        ...
        $query = $this->db->query("SELECT * FROM booking WHERE id = $id");
        return $query->result_array();
    }
    ...
    public function edit()
    {
        ...
        if ($this->input->post('status_pembayaran') == "Belum Bayar DP") {
            $getDataGambar = $this->db->query("SELECT * FROM booking WHERE id = $id_booking");
    ...
    {
        $query = $this->db->query("SELECT * FROM booking where no_ivoice like '%$keyword%' ");
        return $query->result_array();
    }
