                ...
                <?php foreach ($home as $item) { ?>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <input type="text" disabled class="form-control" value="<?= $item['no_invoice'] ?>" id="myInput">
                                </div>
                                <div class="col-lg-2">
                            ...
                            <a href="<?= base_url() ?>pembayaran/cari?invoice=<?= $item['no_invoice'] ?>" class="btn btn-primary">Konfirmasi Pembayaran</a>
                        </div>
                    </div>
                <?php } ?>
            </div>
