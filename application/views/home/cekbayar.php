    ...
    <section id="contact-us" class="contact-us">
        <div class="container">
            <div class="col-lg-12">
                ...
                <span class="text-danger"><i>Hubungi admin jika lupa kode pembayaran dengan menginformasikan nama pemesan</i></span>
                <form action="<?= base_url("pembayaran/cari") ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-8 form-group">
                            <input type="text" name="keyword" class="form-control" id="keyword" placeholder="Kode Pembayaran" required value="<?= $_GET['invoice'] ?? ""; ?>">
                        </div>
