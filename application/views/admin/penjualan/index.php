                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                                <a href="<?php base_url() ?>admin/pos/<?= $mk['no_invoice'] ?>" class="btn btn-sm btn-success"></i>Kasir</a>
                                            <?php
                                            }
                                            ?>
                                            <a href="<?php base_url() ?>penjualan/detail/<?= $mk['no_invoice'] ?>" class="btn btn-sm btn-warning"></i>Detail</a>
                                            <a href="<?php base_url() ?>penjualan/cetakNotaPenjualan/<?= $mk['no_invoice'] ?>" target="_blank" class="btn btn-sm btn-danger"><i class="fa fa-print"></i> Cetak Nota</a>
                                        </td>
                                    </tr>
                                <?php
                                    $no++;
