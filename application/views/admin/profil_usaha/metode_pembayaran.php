                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $m['atas_nama'] ?></td>
                                        <td>
                                            <button data-toggle="modal" data-target="#editmetodemodal" onclick="edit_metode(<?= $m['id'] ?>)" class="btn btn-sm btn-warning">Edit</button>
                                            <a href="<?= base_url() ?>profilusaha/hapusmetodepembayaran/<?= $m['id'] ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Metode Pembayaran <?= $m['nama_merchant'] ?>?');" class="btn btn-sm btn-danger">Hapus</a>
                                        </td>
                                        </td>
                                    </tr>
                                <?php
