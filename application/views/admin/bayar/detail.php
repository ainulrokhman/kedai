                    ...
                    <form action="<?= base_url() ?>pembayaran/prosesEdit" method="post" enctype="multipart/form-data">
                        ...
                        foreach ($booking as $b) { ?>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"> <label><?= $b['no_invoice'] ?></label></div>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="exampleFormControlSelect1">Dibayar Melalui : </label></div>
                                <div class="col-12 col-md-9">
                                    <select class="form-control" id="exampleFormControlSelect1" name="metode">
                                        <?php foreach ($metode as $m) : ?>
                                            <option value="<?= $m['id']; ?>"><?= $m['nama_merchant']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
