                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                                <a href="<?php base_url() ?>pembayaran/detail/<?= $mk['id'] ?>" class="btn btn-sm btn-info btn-sm">Lihat Gambar</a>
                                                <!-- <button data-toggle="modal" data-target="#detailmodal" onclick="detail(<?= $mk['id'] ?>)" class="btn btn-sm btn-warning">Detail</button> -->
                                        ...
                                        <td>
                                            ...
                                            ?>
                                                <a href="<?php base_url() ?>pembayaran/edit/<?= $mk['id'] ?>" class="btn btn-sm btn-warning">Verifikasi</a>
                                                <!-- <button data-toggle="modal" data-target="#konfirmasimodal" onclick="konfirmasi(<?= $mk['id'] ?>)" class="btn btn-sm btn-warning">Konfirmasi</button> -->
                                                <a href="<?php base_url() ?>pembayaran/delete/<?= $mk['id'] ?>" onclick="return confirm('Apakah anda yakin ingin menghapus? Jika anda menghapus menu ini maka gambar menu ini ikut terhapus.')" class="btn btn-sm btn-danger"> Hapus</a>
                                            <?php
                                            } ?>
                                        </td>
                                    </tr>
